...
W='\033[0m'
# The Credit Goes To AAshAN And All Other Contributors Listed At https://github.com/cipher486/445-4N
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("==================================================================")
        print("                BOMBING is in progress bro, please wait !!               ")
        print("     Please keep your internet on !!  ")
        print("==================================================================")
        ...
        print("==================================================================")
        print("              This is just an entertainment of AAshAN !!                ")
        print("==================================================================")
        try:
...
if nm == 0:
    ...
    print("              This Bomber Was Created By AAshAN !!                ")
    print("==================================================================")
    print(W)
